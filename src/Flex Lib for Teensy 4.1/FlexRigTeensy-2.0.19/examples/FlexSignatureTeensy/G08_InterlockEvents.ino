...
// void onInterlock_timeout() {
   // Serial.println("onInterlock_timeout() event!");
// }

// void onInterlock_acc_txreq_enable() {
   // Serial.println("onInterlock_acc_txreq_enable() event!");
// }

// void onInterlock_rca_txreq_enable() {
   // Serial.println("onInterlock_rca_txreq_enable() event!");
// }

// void onInterlock_acc_txreq_polarity() {
   // Serial.println("onInterlock_acc_txreq_polarity() event!");
// }

// void onInterlock_rca_txreq_polarity() {
   // Serial.println("onInterlock_rca_txreq_polarity() event!");
// }

// void onInterlock_tx1_enabled() {
   // Serial.println("onInterlock_tx1_enabled() event!");
// }

// void onInterlock_tx1_delay() {
   // Serial.println("onInterlock_tx1_delay() event!");
// }

// void onInterlock_tx2_enabled() {
   // Serial.println("onInterlock_tx2_enabled() event!");
// }

// void onInterlock_tx2_delay() {
   // Serial.println("onInterlock_tx2_delay() event!");
// }

// void onInterlock_tx3_enabled() {
   // Serial.println("onInterlock_tx3_enabled() event!");
// }

// void onInterlock_tx3_delay() {
   // Serial.println("onInterlock_tx3_delay() event!");
// }

// void onInterlock_acc_tx_enabled() {
   // Serial.println("onInterlock_acc_tx_enabled() event!");
// }

// void onInterlock_acc_tx_delay() {
   // Serial.println("onInterlock_acc_tx_delay() event!");
// }

// void onInterlock_tx_delay() {
   // Serial.println("onInterlock_tx_delay() event!");
// }

// void onInterlock_state() {
  // Serial.println("onInterlock_state() event!");
// }

// void onInterlock_reason() {
   // Serial.println("onInterlock_reason() event!");
// }
