...
// void onTransmit_freq() {
   // Serial.println("onTransmit_freq() event!");
// }


// void onTransmit_lo() {
  // Serial.println("onTransmit_lo() event!");
// }

// void onTransmit_hi() {
  // Serial.println("onTransmit_hi() event!");
// }

// void onTransmit_rfpower() {
  // Serial.println("onTransmit_rfpower() event!");
// }

// void onTransmit_tunepower() {
  // Serial.println("onTransmit_tunepower() event!");
// }

// void onTransmit_am_carrier_level() {
  // Serial.println("onTransmit_am_carrier_level() event!");
// }

// void onTransmit_vox_enable() {
  //Serial.println("onTransmit_vox_enable() event!");
// }

// void onTransmit_vox_level() {
  // Serial.println("onTransmit_vox_level() event!");
// }

// void onTransmit_vox_delay() {
  // Serial.println("onTransmit_vox_delay() event!");
// }

// void onTransmit_mic_level() {
  // Serial.println("onTransmit_mic_level() event!");
// }

// void onTransmit_mic_boost() {
   // Serial.println("onTransmit_mic_boost() event!");
// }

// void onTransmit_mic_bias() {
   // Serial.println("onTransmit_mic_bias() event!");
// }

// void onTransmit_mic_acc() {
   // Serial.println("onTransmit_mic_acc() event!");
// }

// void onTransmit_compander() {
  //Serial.println("onTransmit_compander() event!");
// }

// void onTransmit_compander_level() {
  // Serial.println("onTransmit_compander_level() event!");
// }

// void onTransmit_dax() {
   // Serial.println("onTransmit_dax() event!");
// }

// void onTransmit_pitch() {
   // Serial.println("onTransmit_pitch() event!");
// }

// void onTransmit_speed() {
   // Serial.println("onTransmit_speed() event!");
// }

// void onTransmit_iambic() {
  //Serial.println("onTransmit_iambic() event!");
// }

// void onTransmit_iambic_mode() {
   // Serial.println("onTransmit_iambic_mode() event!");
// }

// void onTransmit_cwl_enabled() {
   // Serial.println("onTransmit_cwl_enabled() event!");
// }

// void onTransmit_swap_paddles() {
   // Serial.println("onTransmit_swap_paddles() event!");
// }

// void onTransmit_break_in() {
  //Serial.println("onTransmit_break_in() event!");
// }

// void onTransmit_break_in_delay() {
   // Serial.println("onTransmit_break_in_delay() event!");
// }

// void onTransmit_sidetone() {
  //Serial.println("onTransmit_sidetone() event!");
// }

// void onTransmit_monitor() {
  //Serial.println("onTransmit_monitor() event!");
// }

// void onTransmit_sb_monitor() {
  //Serial.println("onTransmit_sb_monitor() event!");
// }

// void onTransmit_mon_gain_cw() {
  // Serial.println("onTransmit_mon_gain_cw() event!");
// }

// void onTransmit_mon_gain_sb() {
  // Serial.println("onTransmit_mon_gain_sb() event!");
// }

// void onTransmit_mon_pan_cw() {
  // Serial.println("onTransmit_mon_pan_cw() event!");
// }

// void onTransmit_mon_pan_sb() {
   // Serial.println("onTransmit_mon_pan_sb() event!");
// }

// void onTransmit_tune() {
   // Serial.println("onTransmit_tune() event!");
// }

// void onTransmit_met_in_rx() {
   // Serial.println("onTransmit_met_in_rx() event!");
// }

// void onTransmit_hwalc_enabled() {
   // Serial.println("onTransmit_hwalc_enabled() event!");
// }

// void onTransmit_inhibit() {
   // Serial.println("onTransmit_inhibit() event!");
// }

// void onTransmit_speech_processor_enable() {
  //Serial.println("onTransmit_speech_processor_enable() event!");
// }

// void onTransmit_speech_processor_level() {
   // Serial.println("onTransmit_speech_processor_level() event!");
// }

// void onTransmit_show_tx_in_waterfall() {
   // Serial.println("onTransmit_show_tx_in_waterfall() event!");
// }
