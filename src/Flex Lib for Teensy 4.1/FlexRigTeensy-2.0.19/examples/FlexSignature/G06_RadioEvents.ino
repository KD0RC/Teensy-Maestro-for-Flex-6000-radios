...
// void onRadio_slices() {
  // Serial.println("onRadio_slices() event!");
// }

// void onRadio_panadapters() {
  // Serial.println("onRadio_panadapters() event!");
// }  

// void onRadio_lineout_gain() {
  //  Serial.println("onRadio_lineout_gain() event!");
// } 

// void onRadio_lineout_mute() {
  // Serial.println("onRadio_lineout_mute() event!");
// }  

// void onRadio_headphone_gain() {
  // Serial.println("onRadio_headphone_gain() event!");
// }  
...
// void onRadio_remote_on_enabled() {
  // Serial.println("onRadio_remote_on_enabled() event!");
// } 

// void onRadio_pll_done() {
  // Serial.println("onRadio_pll_done() event!");
// } 

// void onRadio_freq_error_ppb() {
  // Serial.println("onRadio_freq_error_ppb() event!");
// } 

// void onRadio_cal_freq() {
  // Serial.println("onRadio_cal_freq() event!");
// }

// void onRadio_tnf_enabled() {
  // Serial.println("onRadio_tnf_enabled() event!");
// } 

// void onRadio_snap_tune_enabled() {
  // Serial.println("onRadio_snap_tune_enabled() event!");
// } 

// void onRadio_nickname() {
  // Serial.println("onRadio_nickname() event!");
// } 

// void onRadio_callsign() {
  // Serial.println("onRadio_callsign() event!");
// }
